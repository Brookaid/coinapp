package fr.coinapp.application.bittrexWallet.views;
...
import fr.coinapp.application.bittrexWallet.news.NewsItem;
import fr.coinapp.application.bittrexWallet.news.WebViewActivity;
