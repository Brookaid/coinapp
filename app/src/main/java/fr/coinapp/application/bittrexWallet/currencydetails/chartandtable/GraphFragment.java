package fr.coinapp.application.bittrexWallet.currencydetails.chartandtable;
...
import fr.coinapp.application.bittrexWallet.currencydetails.CustomViewPager;
import fr.coinapp.application.bittrexWallet.formatters.MonthSlashDayDateFormatter;
import fr.coinapp.application.bittrexWallet.formatters.MonthSlashYearFormatter;
import fr.coinapp.application.bittrexWallet.formatters.TimeDateFormatter;
import fr.coinapp.application.bittrexWallet.models.rest.CMCChartData;
import fr.coinapp.application.bittrexWallet.models.rest.CMCCoin;
import fr.coinapp.application.bittrexWallet.rest.CoinMarketCapService;
import fr.coinapp.application.bittrexWallet.singletons.CurrencyFormatterSingleton;
...
import static fr.coinapp.application.bittrexWallet.rest.CoinMarketCapService.COIN_MARKETCAP_CHART_URL_ALL_DATA;
import static fr.coinapp.application.bittrexWallet.rest.CoinMarketCapService.COIN_MARKETCAP_CHART_URL_WINDOW;
...
public class GraphFragment extends Fragment implements OnChartValueSelectedListener {
    ...
    public static final String SHAREDPREF_SETTINGS = "coinapp_settings";
